...
usage() {
  print -u2 -- "usage: $0 [--herdr-bin PATH]"
}
...
jq -n \
  ...
  '{status: "pass", herdr_bin: $herdr_bin, version: $version, protocol: $protocol, schema_sha256: $schema_sha256, workspaces: $workspaces, panes: $panes}'
