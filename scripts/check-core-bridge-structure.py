...
EXPECTED_DECLARATIONS: dict[str, tuple[Declaration, ...]] = {
    ...
    "CoreBridgeEditorSnapshot.swift": (
        ...
        ("struct", "CoreArchiveDetailSnapshot", "internal"),
        ("struct", "CoreArchiveEventSnapshot", "internal"),
        ("struct", "CoreMemoryDetailSnapshot", "internal"),
        ("struct", "CoreMemorySourceSnapshot", "internal"),
        ("struct", "CoreMemoryRevisionSnapshot", "internal"),
    ...
    "CoreBridgeSessionsSnapshot.swift": (
        ("enum", "CoreSessionsMode", "internal"),
        ("enum", "CoreSessionsProviderFilter", "internal"),
        ("struct", "CoreSessionsSnapshot", "internal"),
        ("struct", "CoreSessionRowSnapshot", "internal"),
        ("struct", "CoreMemoryRowSnapshot", "internal"),
        ("struct", "CoreMemoryAnalysisSnapshot", "internal"),
        ("struct", "CoreMemoryNoticeSnapshot", "internal"),
    ),
    ...
    "CoreBridgeWorkspaceSnapshot.swift": (
        ...
        ("struct", "CoreWorkspaceRemovalGateSnapshot", "internal"),
        ("struct", "CoreCheckoutAgentSummary", "internal"),
        ("struct", "CoreCheckoutPurpose", "internal"),
        ...
        ("struct", "CoreDescendantCounts", "internal"),
    ),
}
