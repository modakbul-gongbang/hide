#!/usr/bin/env bash
# The right panel presents exactly Overview, Explorer, History and Sessions, and
...
printf 'right panel presents exactly Overview, Explorer, History and Sessions; no Workbench string remains\n'
