...
| Browser chrome `KUcQU`, address toolbar `eMlZD`, document toolbar `hxdu7` | `EditorViewerOverlay.swift` | Browser, file, and diff surfaces keep their own controls and never inherit agent-only actions. |
