...
| File toolbar, Markdown Live and Source modes, draft lifecycle and link security | [DESIGN.md: File document toolbar and Markdown](../DESIGN.md#file-document-toolbar-and-markdown) | `EditorViewerOverlay.swift`, `MarkdownLiveEditor.swift`, `MarkdownLiveSource.swift`, `MarkdownListEditing.swift`, `HighlightedCodeEditor.swift`, core editor events, `MarkdownLiveSourceTests`, `MarkdownLiveEditorTests`, `MarkdownListEditingTests` |
