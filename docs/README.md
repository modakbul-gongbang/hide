...
| Shared design library, tokens, task-local scratch and human design approval | [DESIGN.md: Design library and exploration](../DESIGN.md#design-library-and-exploration), [hide-ui.lib.pen](../design/hide-ui.lib.pen) | `HideTheme.swift`, `pen-token-map.json`, `gen-pen.mjs`, `check-design-contract.mjs` |
