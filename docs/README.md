...
| Project activity ordering, Overview, registration removal | [DESIGN.md: Projects and checkout context](../DESIGN.md#projects-and-checkout-context), [bounded projection cost](PERFORMANCE_TESTING.md#projects-and-overview-cost-contract) | `project_context.rs`, `runtime.rs`, `CheckoutOverview.swift`, native sidebar |
