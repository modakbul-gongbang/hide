...
| Terminal image integration limits | [DESIGN.md: Terminal image attachment boundary](../DESIGN.md#terminal-image-attachment-boundary) | `TerminalHost.swift`, `ImeTerminalView.swift`, existing terminal input path |
