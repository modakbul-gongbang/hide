...
| Project Home: the constellation drawn in the empty checkout state and as the overlay, its layout, states and entry points | [DESIGN.md: Project Home](../DESIGN.md#project-home) | `ProjectHome.swift`, `ProjectHomePresentation.swift`, `ProjectHomeGraphLayout.swift`, `ShellModel.projectHomeVisible`, `ProjectHomePresentationTests.swift`, `ProjectHomeGraphLayoutTests.swift` |
