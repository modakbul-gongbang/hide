...
| Web Main, Project Overview and Workspace screens, the Workspace layout, tools and View tabs the core keeps per Workspace, and the pane relationship controls | [ARCHITECTURE.md: Workspaces in the web shell](ARCHITECTURE.md#workspaces-in-the-web-shell), [DESIGN.md: Web Workspace](../DESIGN.md#web-workspace) | `herdr-core/src/workspace_views.rs`, `herdr-core/src/runtime/workspace_view.rs`, `runtime/tests/workspace_view.rs`, `web/src/{navigation,workspace,lineage,viewFocus}.ts`, `web/src/{MainScreen,WorkspaceScreen,Tools,TabBar,PaneRelations,Menu}.tsx`, `web/e2e/s6.spec.ts` |
