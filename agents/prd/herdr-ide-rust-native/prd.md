...
- HD6. warm usable 1초, input-to-present p95 50ms, idle CPU 1%, Browser 닫힘 RSS 200MB, Browser 1개 포함 RSS 600MB를 hard acceptance로 승인하며, preflight가 불가능성을 증명하면 구현자가 수치를 완화하지 않고 재결정을 요청하게 한다.
