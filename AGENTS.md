...
- `herdr-core/src/wire.rs` is the only place generated wire types are converted into the core's inputs; do not write wire deserialization in `session_sync/replica.rs` or import generated types into domain, runtime or sidebar code.
